# team-abbreviation-overrides Specification

## Purpose

Defines per-team abbreviation overrides keyed by stable ESPN team id: their storage and persistence, the contextual (right-click) and settings-based editing to set and reset them, and the resolution of the effective abbreviation wherever a team's abbreviation is displayed.
